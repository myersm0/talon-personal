...
#  m
 ...
 - **tmux left**  `key(ctrl-a)
		insert("h")
		`

 - **tmux right**  `key(ctrl-a)
		insert("l")
		`

 - **tmux fullsize**  `key(ctrl-a)
		insert("z")
		`

 - **tmux seek**  `key(ctrl-a)
		insert("[")
		`

 - **tmux paste**  `key(ctrl-a)
		insert("]")
		`

 - **repl four**  `insert("repl4")
		key(enter)
		`
